...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                {
                    path: '',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | route-base-base-module */ "route-base-base-module").then(__webpack_require__.bind(null, /*! ./route/base/base.module */ "./src/app/route/base/base.module.ts")).then(function (m) { return m.BaseModule; }); }
                }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = ({
                ...
                keywords: __spread([
                    ...
                    .map(function (t) { return Object(_core_helper_combinations__WEBPACK_IMPORTED_MODULE_1__["combinations"])([t.last_name, t.first_name, t.surname]); })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function combinations(arr) {
                ...
                return curr.map(function (c) { return c.join(' '); });
            }
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DeviceDetectorService = /** @class */ (function () {
                function DeviceDetectorService() {
                    var _this = this;
                    this.isMobile = false;
                    window.onresize = function () { return _this.determine(); };
                    if ('screen' in window && 'orientation' in window.screen) {
                        screen.orientation.onchange = function () { return _this.determine(); };
                    }
                    this.determine();
                }
                DeviceDetectorService.prototype.determine = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageParser = /** @class */ (function () {
                ...
                PageParser.prototype.get = function () {
                    var pageType = new _type_page_type__WEBPACK_IMPORTED_MODULE_3__["PageType"]();
                    return src_app_configuration_page_page__WEBPACK_IMPORTED_MODULE_2__["default"].map(function (t) {
                        return {
                            type: pageType,
                            texts: t.keywords,
                            reference: t
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TeacherParser = /** @class */ (function () {
                function TeacherParser() {
                }
                TeacherParser.prototype.get = function () {
                    var teacherType = new _type_teacher_type__WEBPACK_IMPORTED_MODULE_4__["TeacherType"]();
                    return src_app_configuration_teacher_teachers__WEBPACK_IMPORTED_MODULE_3__["default"].map(function (t) {
                        return {
                            type: teacherType,
                            texts: __spread(Object(_core_helper_combinations__WEBPACK_IMPORTED_MODULE_2__["combinations"])([t.first_name, t.surname, t.last_name]), [
                                t.first_name,
                                t.last_name,
                                t.surname,
                                t.description.replace(/<\w+\/?>/g, '')
                            ]).map(function (text) { return text.replace(/(\s){2,}/g, '$1'); }),
                            reference: t
                        };
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaxonomyParser = /** @class */ (function () {
                function TaxonomyParser(teacher, page) {
                    this.teacher = teacher;
                    this.page = page;
                }
                TaxonomyParser.prototype.parse = function () {
                    return __spread(this.teacher.get(), this.page.get());
                };
                return TaxonomyParser;
            }());
            TaxonomyParser.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchService = /** @class */ (function () {
                function SearchService(taxonomy) {
                    this.taxonomy = taxonomy;
                }
                SearchService.prototype.search = function (s) {
                    var e_1, _a, e_2, _b;
                    var complex = [];
                    var taxonomy = this.taxonomy.getAll();
                    try {
                        for (var taxonomy_1 = __values(taxonomy), taxonomy_1_1 = taxonomy_1.next(); !taxonomy_1_1.done; taxonomy_1_1 = taxonomy_1.next()) {
                            var record = taxonomy_1_1.value;
                            var t = 0;
                            try {
                                for (var _c = (e_2 = void 0, __values(record.texts)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    var text = _d.value;
                        ...
                        try {
                            if (taxonomy_1_1 && !taxonomy_1_1.done && (_a = taxonomy_1.return)) _a.call(taxonomy_1);
                        }
                        finally { if (e_1) throw e_1.error; }
                    }
                    return complex.reduce(function (a, b) { return a.concat(b); }, []);
                };
                SearchService.prototype.searchByType = function (s) {
                    var e_3, _a, e_4, _b;
                    var complex = {};
                    var taxonomy = this.taxonomy.getAll();
                    if (s) {
                    ...
                    try {
                        for (var taxonomy_2 = __values(taxonomy), taxonomy_2_1 = taxonomy_2.next(); !taxonomy_2_1.done; taxonomy_2_1 = taxonomy_2.next()) {
                            var record = taxonomy_2_1.value;
                            var t = 0;
                            try {
                                for (var _c = (e_4 = void 0, __values(record.texts)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    var text = _d.value;
                                    if (text.toLocaleLowerCase().includes(s)) {
                        ...
                        try {
                            if (taxonomy_2_1 && !taxonomy_2_1.done && (_a = taxonomy_2.return)) _a.call(taxonomy_2);
                        }
                    ...
                    for (var c in complex) {
                        if (complex.hasOwnProperty(c)) {
                            results[c] = complex[c].reduce(function (a, b) { return a.concat(b); }, []);
                        }
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaxonomyService = /** @class */ (function () {
                function TaxonomyService(parser) {
                    this.taxonomy = [];
                    this.add.apply(this, __spread(parser.parse()));
                }
                TaxonomyService.prototype.add = function () {
                    var _a;
                    var r = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        r[_i] = arguments[_i];
                    }
                    (_a = this.taxonomy).push.apply(_a, __spread(r));
                };
                TaxonomyService.prototype.getType = function (t) {
                    var sr = Object(util__WEBPACK_IMPORTED_MODULE_2__["isString"])(t) ? t : t.id;
                    return this.taxonomy.filter(function (t) { return t.type.id === sr; });
                };
                TaxonomyService.prototype.getTypes = function (ts) {
                    var ids = ts.map(function (t) { return Object(util__WEBPACK_IMPORTED_MODULE_2__["isString"])(t) ? t : t.id; });
                    return this.taxonomy.filter(function (t) { return ids.includes(t.type.id); });
                };
                TaxonomyService.prototype.getAll = function () {
                    return __spread(this.taxonomy);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var TeacherType = /** @class */ (function () {
